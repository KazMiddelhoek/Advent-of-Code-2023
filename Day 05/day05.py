...
for conversion_line in lines[2:]:
    ...
    for to_convert_range_start, to_convert_range_length_number in number_ranges_to_convert.copy():
        ...
        if (to_convert_range_start + to_convert_range_length_number < source_range_start or 
            to_convert_range_start > source_range_start + range_length_line): # no overlap
            number_ranges_to_convert += [(to_convert_range_start, to_convert_range_length_number)]
            continue

        overlapping_range_start = max(source_range_start, to_convert_range_start)
        overlapping_range_length = min(source_range_start+range_length_line, to_convert_range_start + to_convert_range_length_number) - overlapping_range_start
        ...
        if (to_convert_range_start < source_range_start and to_convert_range_start+to_convert_range_length_number >= source_range_start):
            ...
            number_ranges_to_convert += [(
                overlapping_range_start+overlapping_range_length, 
